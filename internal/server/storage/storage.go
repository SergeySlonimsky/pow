...
func New() *QuoteStorage {
	return &QuoteStorage{
		data: []string{
			...
			`At the end of your day, you’ve done your best. Even if you haven’t accomplished all that’s on your list. 
You’ve given it you’re all.`,
...
func (s *QuoteStorage) GetRandomQuote() string {
	return s.data[rand.Intn(len(s.data))] //nolint:gosec // it's ok for random quote
}
